  ...
  const getData = async () => {
    try {
      ...
      if (programName === "Bimbingan Beasiswa") {
        data = data.filter((item) => item.category === "Bimbingan Beasiswa");
      } else if (programName === "Webinar") {
        data = data.filter((item) => item.category === "Webinar");
      } else if (programName === "Persiapan Tes") {
        data = data.filter((item) => item.category === "Persiapan Tes");
      }
      setRawData(data);
    } catch (error) {
...
export default ManagementClassTeacher;

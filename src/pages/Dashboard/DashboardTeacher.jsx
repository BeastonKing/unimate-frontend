...
const DashboardTeacher = () => {
  ...
  const getAllUjian = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_UNIMATE_BE_SERVICES}/api/ujian/get-all/by-teacher/` +
          auth.id_user,
        {
          headers: {
            Authorization: authHeader,
      ...
      console.error('Error fetching all ujian:', error);
    }
  };
                ...
                <NavLink to={"/admin/user-management"} className="flex w-full ">
                  <div className="w-2/3">
                    ...
                    <h1 className="font-semibold text-base text-main-200">
                      Jumlah Kelas yang Diajarkan
                    </h1>
                    <p className="text-sm mt-2 mb-4">{classes.length} Kelas</p>
                  </div>
              ...
              <div className="full border-main-200 border rounded-lg p-4 flex">
                ...
                >
                  <div className="w-2/3">
                    ...
                    <p className="text-sm mt-2 mb-4">{ujian.length} Ujian</p>
                  </div>
                  <div className="mt-8 w-2/5 flex flex-col justify-center items-end">
                    <NavLink
                    ...
                    <NavLink
                      to={"/teacher/examination/add-exam"}
